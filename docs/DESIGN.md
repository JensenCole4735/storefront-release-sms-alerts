...
> Design notes for **storefront-release-sms-alerts** — a runnable python example that Typed Python service that turns storefront build failures and completed releases into transactional SMS alerts.
...
- **Feature code** — the actual task: developer-build-alerts.
